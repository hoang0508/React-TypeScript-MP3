      ...
      <div>
        ...
        <div className="flex gap-x-2 mt-3">
          ...
          <div className="flex flex-wrap items-center gap-x-2">
            <span className="border-t-transparent border-t-[20px] border-l-bgColor2 border-l-[20px] border-b-transparent border-b-[20px] border-r-transparent border-r-[20px]">
              Nhạc trẻ
            </span>
            <span>Nhạc trẻ</span>
          </div>
