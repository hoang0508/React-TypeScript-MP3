      ...
      <div>
        ...
        <div className="flex gap-x-2 mt-3">
          ...
          <div className="flex flex-wrap items-center gap-x-2">
            <span className="border-t-transparent border-t-[50px] border-l-bgColor2 border-l-[50px] border-b-transparent border-b-[50px] border-r-transparent border-r-[50px]">
              Nhạc trẻ
            </span>
            <span>Nhạc trẻ</span>
          </div>
