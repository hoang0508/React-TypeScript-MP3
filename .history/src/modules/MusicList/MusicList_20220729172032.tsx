...
export default function MusicList({ data }: MusicListProps) {
  // data play music
  const [musicDataPlay, setMusicDataPlay] = React.useState<{}>();
  const handlePlayMusic = (item: MusicItemProps) => {
    setMusicDataPlay({ ...item });
  };
  return (
    <div className="w-[800px] mx-auto cursor-pointer">
      ...
      <MusicPlay dataPlay={musicDataPlay}></MusicPlay>
    </div>
  );
}
