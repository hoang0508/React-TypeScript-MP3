...
export default function MusicNCT(props: MusicNCTProps) {
  ...
  // data author song artists
  const dataArtists = data.ranking ? data.ranking?.song?.artists : [];
  console.log(
    "🚀 ~ file: MusicNCT.tsx ~ line 32 ~ MusicNCT ~ dataArtists",
    dataArtists
  );
        ...
        {dataNct &&
          ...
          dataNct.slice(0, 3).map((item: MusicItemType, index: number) => (
            ...
            >
              ...
              {}
              <MusicTitle className="ml-5">abc</MusicTitle>
