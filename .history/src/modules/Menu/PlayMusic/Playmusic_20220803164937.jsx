...
export default function Playmusic() {
  ...
  // const t = h?.streamUrls
  //   ? h?.streamUrls?.streamUrl
  //   : dataSong?.song?.streamUrls[0].streamUrl;
  console.log(
    "🚀 ~ file: Playmusic.jsx ~ line 51 ~ Playmusic ~ t",
    dataSong?.song?.streamUrls[0].streamUrl
  );
    ...
    <div className="flex justify-between flex-col gap-y-[80px]">
      ...
      <div>
        ...
        <div className="mt-4">
          ...
          <audio muted={false} src={configMusicItemMp3} ref={refMp3}></audio>
