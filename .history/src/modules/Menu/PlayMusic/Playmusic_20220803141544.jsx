...
export default function Playmusic() {
  ...
  // console.log("🚀 ~ file: Playmusic.jsx ~ line 21 ~ Playmusic ~ data", data);

  const dataSong = data?.song && data?.song.map((item) => item.key);
  console.log(
    "🚀 ~ file: Playmusic.jsx ~ line 24 ~ Playmusic ~ dataSong",
    dataSong
  );
