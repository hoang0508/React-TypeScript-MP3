...
export default function Playmusic() {
  ...
  console.log(
    "🚀 ~ file: Playmusic.jsx ~ line 44 ~ Playmusic ~ indexSong",
    indexSong
  );
  const h = {
  ...
  const [configMusicItemMp3, setConfigMusicItemMp3] = React.useState(h);
  console.log(
    "🚀 ~ file: Playmusic.jsx ~ line 51 ~ Playmusic ~ configMusicItemMp3",
    configMusicItemMp3
  );
  ...
  console.log(configMusicItemMp3?.streamUrls?.streamUrl);
