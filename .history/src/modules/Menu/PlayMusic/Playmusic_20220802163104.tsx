...
export default function Playmusic(props: PlayMusicProps) {
  ...
  const configItemMp3 = dataSong?.song?.streamUrls[0];
  console.log(
    "🚀 ~ file: Playmusic.tsx ~ line 27 ~ Playmusic ~ configItemMp3",
    configItemMp3
  );
  // const musicMp3 =
  //   configItemMp3 && configItemMp3.map((item: any) => item?.streamUrl);
  // console.log(
  //   "🚀 ~ file: Playmusic.tsx ~ line 31 ~ Playmusic ~ musicMp3",
  //   musicMp3
  // );
