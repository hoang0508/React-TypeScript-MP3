...
export default function Playmusic() {
  ...
  console.log(
    "🚀 ~ file: Playmusic.jsx ~ line 49 ~ Playmusic ~ configMusicItemMp3",
    configMusicItemMp3
  );
  ...
  React.useEffect(() => {
    const FetchDemo = async () => {
      ...
      const res = await getSong(finalH[indexSong]);
      console.log("🚀 ~ file: Playmusic.jsx ~ line 107 ~ FetchDemo ~ res", res);
      setDataDemo(res);
      return res;
    };
    FetchDemo();
  ...
  console.log(
    "🚀 ~ file: Playmusic.jsx ~ line 100 ~ Playmusic ~ dataDemo",
    dataDemo?.song.streamUrls[0]?.streamUrl
  );
  ...
  function changeSong(dir) {
    if (dir === 1) {
      ...
      setConfigMusicItemMp3(dataDemo?.song.streamUrls[0]?.streamUrl);
      handleClickPlay();
    }
  }
