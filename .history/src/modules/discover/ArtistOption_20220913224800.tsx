...
const data = [{ id: 1, name: "a" },id: 1, name: "a" },id: 1, name: "a" },id: 1, name: "a" },id: 1, name: "a" },id: 1, name: "a" },id: 1, name: "a" },id: 1, name: "a" }];
...
export default function ArtistOption(props: IArtistOptionProps) {
  ...
  // state change text
  const [selectText, setSelectText] = React.useState<any>("All");
