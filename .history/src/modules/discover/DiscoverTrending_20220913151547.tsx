...
export default function DiscoverTrending(props: IDiscoverTrendingProps) {
  ...
  console.log(
    "🚀 ~ file: DiscoverTrending.tsx ~ line 15 ~ DiscoverTrending ~ artistTrending",
    artistTrending
  );
            ...
            {artistTrending &&
              ...
              artistTrending.map(
                (item: ITrendingArtistsType, index: number) => (
                  <div key={v4()} className="w-[50%] flex gap-x-2 items-center">
                    <span className="text-text2">{index + 1}</span>
