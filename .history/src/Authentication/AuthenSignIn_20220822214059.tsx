    ...
    >
      <LayoutAuthen heading="Đăng nhập" onClick={handleCloseSignIn}>
        ...
        >
          ...
          <ButtonAuthen isLoading={isSubmitting}>Đăng nhập</ButtonAuthen>
        </form>
        <div className="flex justify-center items-center gap-x-2 bg-bgColor2 py-3">
          <p className="text-text2">Hoặc đăng nhập bằng : </p>
          <AuthenSocial />
        </div>
        <div className="flex justify-center items-center py-4 text-xs text-text2">
          <p>Bạn chưa có tài khoản NCT ID?</p>
          <span className="text-primary" onClick={() => handleNavigateSignUp()}>
            Đăng ký ngay
          </span>
        </div>
      </LayoutAuthen>
